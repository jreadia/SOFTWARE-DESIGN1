...
def calculate_map(model, dataloader, device):
    ...
    try:
        ...
        # Binarize labels for multi-class mAP calculation
...
def main():
    print(f"--- Starting MobileNetV2 Training & Analysis (PyTorch) ---")
    ...
    # Batch size 1 for testing timing/accuracy per image
    ...
    # A. Manufacturability (Total Parameters)
    total_params = sum(p.numel() for p in model.parameters())
    
    # B. Efficiency (Inference Time)
    model.eval()
    ...
    # --- FINAL REPORT ---
    print("\n" + "="*50)
    print("RUST DETECTION MODEL: MOBILENETV2 (PyTorch)")
    print("="*50)
